...
### BFS 
https://github.com/wilison1992/Algorithm-Practice/blob/master/pictures/BFS.png?raw=true  
...
### DFS
https://github.com/wilison1992/Algorithm-Practice/blob/master/pictures/DFS.png?raw=true    
```python
### Tree is an object of Binary Trees
from collections import deque
def iterativeBFS(tree):
